	...
	return (
		...
		<div className="bg-white text-xl md:px-2 flex  border-dashed border-b-2 border-gray-100 p-2">
			...
			<div className="ml-auto md:mr-4 flex items-center ">
				...
				<a href="https://home.naigai.fun" target="_blank" rel="noreferrer" className="bg-gray-700 hover:bg-gray-800 px-4 rounded-full p-1 text-white md:text-sm md:flex hidden items-center text-xs mx-2 font-Nunito">⭐ 奶盖大人的足迹</a>
